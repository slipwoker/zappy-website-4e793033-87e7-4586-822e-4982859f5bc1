  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      inputs.forEach(function(input) {
        ...
        } else if (input.type === 'tel' && input.value.trim() && input.hasAttribute('pattern')) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Eden israeli משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var response = await fetch(apiBase + '/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '4e793033-87e7-4586-822e-4982859f5bc1',
                    name: data.name || '',
                    email: data.email || '',
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4e793033-87e7-4586-822e-4982859f5bc1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4e793033-87e7-4586-822e-4982859f5bc1';
